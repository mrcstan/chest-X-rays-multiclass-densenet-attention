...
Densenet
'''
# From https://github.com/pytorch/vision/blob/release/0.9/torchvision/models/densenet.py
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        # Linear layer
        self.classifier = nn.Linear(num_features+n_non_im_features, num_classes)
    ...
    def forward(self, x: Tensor, y: Tensor) -> Tensor:
        ...
        out = torch.cat((out, non_image_out), dim=1)
